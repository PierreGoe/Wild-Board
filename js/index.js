...
const wildersInfos = [
    ...
    new Wilders("Marion", "Grolleau", "27/11/1990", 1990, 11, 27, "Oui, un chat et un chien", "Arizona et Rio", "Le poulet au curry", "Je sais jongler à 3 balles!", "Cinéma, concerts, festival, jeux de sociétés, sport", "Sport, handicap, associatif, évènementiel", "J'ai intégré la Wild pour acquérir de nouvelles compétences et souhaite devenir développeuse car le monde de la tech m'intéresse, et c'est le métier qui semble me convenir le mieux", "./source/image/users/marion", "https://www.linkedin.com/in/mariongrolleau", "https://github.com/Mariion-62", "https://www.linkedin.com/in/mariongrolleau"),
    new Wilders("Tchoupi", "Tchoupi", "01/02/1999", 1999, 02, 01, "XXX", "XXX", "XXX XXX", "XXX XXXXXX XX", "XXX XXXXXXX XX", "XXXX XXXXXXXXXXXXXXXXX XXX", "./source/image/users/tchoupi", "https://www.google.com", "https://www.google.com", "https://www.google.com"),
    new Wilders("Nacyme", "Gallel", "02/12/1992", 1992, 12, 02, "Oui, un chat et une tortue", "Mimolette et Slim", "La Mloukhia", "J'ai déjà mangé une raclette en été", "Jeux vidéo, manga, cinéma, développer", "J'suis chaud à Tétris", "J'ai intégré la Wild pour être développeur car je pense que c'est un métier qui me correspond plus que ce que j'ai fait précedemment", "./source/image/users/nacyme", "https://www.linkedin.com/in/NacymeG", "https://github.com/NacymeG", "https://www.linkedin.com/in/NacymeG"),
...
btnFlame.addEventListener('click', function() {
    ...
    document.querySelector("section").style.backgroundImage = `url('https://c.tenor.com/jnyLvpwBKOUAAAAi/fireplace-fire.gif')`;
})
...
window.addEventListener("scroll", ()=>{
  if ((window.scrollY <= 610 && window.innerWidth <= 480) || window.innerWidth >=480 ) {
